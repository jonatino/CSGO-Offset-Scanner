...
public final class Offsets {
	...
	public static void load() {
		...
		m_dwLocalPlayer = PatternScanner.getAddressForPattern(OffsetManager.clientModule(), 0x1, 0x2C, PatternScanner.READ | PatternScanner.SUBTRACT, 0xA3, 0x00, 0x00, 0x00, 0x00, 0xC7, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x59, 0xC3, 0x6A, 0x00);
		 ...
		 * Engine.dll offsets
		 */
		m_dwGlobalVars = PatternScanner.getAddressForPattern(OffsetManager.engineModule(), 0xC, 0x0, PatternScanner.READ | PatternScanner.SUBTRACT, 0x8B, 0x0D, 0x0, 0x0, 0x0, 0x0, 0x83, 0xC4, 0x04, 0x8B, 0x01, 0x68, 0x0, 0x0, 0x0, 0x0, 0xFF, 0x35);
